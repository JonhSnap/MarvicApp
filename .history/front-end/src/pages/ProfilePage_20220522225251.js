    ...
    <div className="w-full">
      ...
      <div className="w-[400px] mx-auto mt-10">
        <div className="flex flex-col justify-center">
          <h2 className="text-base text-[#172b4d] text-center">
            Quản lý thông tin cá nhân của bạn, đồng thời kiểm soát thông tin nào
            người khác xem được và ứng dụng nào có thể truy cập.
          </h2>
          <span className="text-base text-[#0065ff] text-center mt-8">
            Tìm hiểu thêm về hồ sơ và chế độ hiển thị của bạn hoặc xem chính
            sách quyền riêng tư của chúng tôi. Ảnh hồ sơ v
          </span>
        </div>
      </div>
    </div>
