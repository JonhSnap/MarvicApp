      ...
      <div className="w-[600px] mx-auto mt-10">
        ...
        <div className="w-full mt-4">
          ...
          <div className="w-full h-[212px] bg-[#a4f0fc] rounded-lg  border-slate-500 border-2">
            <div className="h-[100px] bg-white p-10">
            ...
            <div className="mt-10">
              <input
                ...
                accept="image/*"
              />
              <div className="inline-block p-2 mt-1 text-white bg-black cursor-pointer label-avt rounded-2xl">
                <label
                  htmlFor="input-avt"
                  className="flex items-center image-upload"
                >
                  <svg
