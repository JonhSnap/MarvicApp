    ...
    <>
      ...
      >
        ...
        <div className="flex items-center h-full right-item w-fit">
          ...
          <div className="whitespace-nowrap h-4 w-auto uppercase text-xs font-bold  mx-2 border-solid border-[0.5px] border-[rgb(204,204,204)] flex justify-center items-center py-3 px-2 bg-[#ccc]">
            INPROGEss
          </div>
          <MemberComponent
            project={project}
