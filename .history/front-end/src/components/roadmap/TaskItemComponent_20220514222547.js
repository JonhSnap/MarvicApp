    ...
    <>
      ...
      >
        <div className="flex items-center h-full left-item">
          ...
          <div className="inline-block mx-1 whitespace-nowrap">
        ...
        <div className="flex items-center h-full right-item w-fit">
          ...
          <div className="whitespace-nowrap  w-auto uppercase text-xs font-bold  mx-2  border-[rgb(204,204,204)] flex justify-center items-center py-3 px-2 ">
            INPROGESS
          </div>
          <MemberComponent
            project={project}
          ...
          {/* <OptionComponent
            child={
              <OptionItemBacklogComponent project={project} issue={issue} />
            }
          /> */}
        </div>
      </div>
