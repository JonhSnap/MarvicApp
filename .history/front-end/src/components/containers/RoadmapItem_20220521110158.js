...
const RoadmapItem = ({ item, project, epic, issueEpicsIndex }) => {
  ...
  return (
    <>
      ...
      <div
        key={v4()}
        className={`parent w-full px-3 py-1 relative flex flex-col font-semibold ${
          issueEpicsIndex ? "bg-slate-700" : ""
        }   rounded-[5px] mb-1  cursor-pointer
        `}
      >
        <div
