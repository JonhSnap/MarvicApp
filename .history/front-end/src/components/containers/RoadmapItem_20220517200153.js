      ...
      >
        ...
        >
          <div className="flex items-center">
            ...
            <div className="h-5 flex-2 w-5 inline-block bg-[#d0c6ff] rounded-[5px] mx-2">
              {item.summary}
            </div>
            <div className="flex-1 w-[25px] h-[25px] items-center flex justify-center rounded-lg bg-slate-200 hover:bg-slate-300">
              <span className="">
                <svg
