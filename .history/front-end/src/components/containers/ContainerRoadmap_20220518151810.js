...
const ContainerRoadmap = ({ project }) => {
  ...
  // const projectId = projects.find((item) => item.key === key);
  useEffect(() => {
  ...
  return (
    <div className="container">
      ...
      <div className="flex overflow-x-auto have-y-scroll  h-[470px]">
        <div className="border-2 overflow-y-auto have-y-scroll  border-slate-200  outline-none out basis-[30%]">
          <div className="epic-dropdown have-y-scroll p-2 w-[300px] have-y-scroll  overflow-y-auto mx-4 bg-white rounded-[5px] flex items-center flex-col">
