    ...
    <div className="container">
          ...
          <div className="filters">
            ...
            >
              ...
              <div
                ...
                className="epic-dropdown z-[9999] have-y-scroll p-2 w-full h-[200px] overflow-y-auto  bg-white rounded-[5px] flex items-center flex-col"
              >
      ...
      <div className="flex overflow-x-auto have-y-scroll w-full  h-[470px]">
        <div className="border-2 overflow-y-auto have-y-scroll  border-slate-200  outline-none out basis-[30%]">
          <div className=" max-w-[300px] w-[300px] w-full epic-dropdown have-y-scroll p-2  have-y-scroll  overflow-y-auto mx-4 bg-white rounded-[5px] flex items-center flex-col">
