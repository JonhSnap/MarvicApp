      ...
      >
        ...
        >
          <div className="flex items-center">
            ...
            />
            <div className="h-5 w-5 inline-block bg-[#d0c6ff] rounded-[5px] mx-2">
              {item.summary}
            </div>
          </div>
          <div className="icon-plus  w-[25px] h-[25px] top-1/3 right-2 items-center flex justify-center rounded-lg bg-slate-200 hover:bg-slate-300">
            <span className="">
              <svg
