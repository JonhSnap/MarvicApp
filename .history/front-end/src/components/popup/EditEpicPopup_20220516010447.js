          ...
          <div className="item w-full h-13 p-1 bg-white px-4 mt-[-1px] border-solid border-[1px] border-[#ccc] flex justify-between items-center flex-wrap">
            ...
            <div className="w-[60%]">
              <DatePicker
                ...
                className="p-2 border-2 border-blue-400 rounded-lg w-[20%] mb-5 inline-block relative z-10"
                minDate={project?.dateStarted}
