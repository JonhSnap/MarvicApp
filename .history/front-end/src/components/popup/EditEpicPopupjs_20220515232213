        ...
        flex flex-col flex-[2]  mx-4 relative p-5 rounded-md'>
                ...
                <div className='flex items-center'>
                    <div className='inline-flex flex-col my-4 w-fit'>
                        <div className='uppercase flex items-center p-2 bg-[#ccc] w-fit rounded-[5px] mx-4 whitespace-nowrap'>
                            to do
                            <FontAwesomeIcon size='1x' className='inline-block px-2' icon={faAngleDown} />
                        </div>
                    </div>
                    {
                        issue?.isFlagged === 1 &&
                ...
                <div className='child-isue'>
                    ...
                    <div className='item w-full h-13 p-1 bg-white px-4 mt-[-1px] border-solid border-[1px] border-[#ccc] flex justify-between items-center'>
                        <div className='flex items-center h-full left-item'>
                            <div className='inline-block mx-1 icon'>
                ...
                <div className='flex flex-col'>
                    ...
                    <div className='flex justify-between'>
                        ...
                        <div className='inline-flex items-center justify-center h-5 p-2 mx-2 w-fit'>Newest first
                            <FontAwesomeIcon size='1x' className='inline-block px-2' icon={faArrowDownWideShort} />
                        </div>
                    </div>
                </div>
