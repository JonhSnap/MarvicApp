      ...
      >
        ...
        <div className="flex flex-col child-isue">
          <div className="flex items-center justify-between w-full my-2 h-11">
            <div className="flex flex-col m-1 font-bold h-[200px] overflow-y-auto have-y-scroll">
              <h2>child issue</h2>
              <div>
                <WrapperTask
                  members={members}
        ...
        <div className="mb-6 link-issue">
          <div className="flex items-center justify-between w-full my-2 h-11 mt-[160px] w-full">
