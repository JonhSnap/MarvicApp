  ...
  return (
    <div className="flex items-center justify-around">
      <div className="relative flex flex-col">
        ...
        {showEdit && (
          <div>
            <div className="absolute right-[28px] flex items-center justify-center rounded-lg w-7 h-7 bg-slate-200">
              <svg
            ...
            <div className="absolute right-0 flex items-center justify-center rounded-lg w-7 h-7 bg-slate-200">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-6 w-6"
                fill="none"
