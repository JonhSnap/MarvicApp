                        ...
                        if (item.id == count) {
                            ...
                            html = <div id='main-tutorial'>
                                ...
                                >
                                    ...
                                    {booleanImg && <><motion.div whileHover={{scale: 1.03, boxShadow: "0px 0px 8px #000"}} className='image-large' style={{ backgroundImage: "url(" + item.imageLager + ")" }} onClick={() => clickImg(true, item.imageLager)}></motion.div>
                                        <motion.div whileHover={{scale: 1.03, boxShadow: "0px 0px 8px #000"}} className='image-child-1' style={{ backgroundImage: "url(" + item.imageChild1 + ")" }} onClick={() => clickImg(true, item.imageChild1)}></motion.div>
                                        <motion.div whileHover={{scale: 1.03, boxShadow: "0px 0px 8px #000"}} className='image-child-2' style={{ backgroundImage: "url(" + item.imageChild2 + ")" }} onClick={() => clickImg(true, item.imageChild2)}></motion.div>
                                        <motion.div whileHover={{scale: 1.03, boxShadow: "0px 0px 8px #000"}} className='image-child-3' style={{ backgroundImage: "url(" + item.imageChild3 + ")" }} onClick={() => clickImg(true, item.imageChild3)}></motion.div>
                                        <motion.div whileHover={{scale: 1.03, boxShadow: "0px 0px 8px #000"}} className='image-child-4' style={{ backgroundImage: "url(" + item.imageChild4 + ")" }} onClick={() => clickImg(true, item.imageChild4)}></motion.div></>}
                                </motion.div>
                            </div>
                        }
