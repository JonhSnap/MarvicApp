...
function OptionsEditIssue({ setShowAddchild, setShowAttachment }) {
    return (
        <div className='relative flex items-center justify-center cursor-pointer'>
            ...
            <input hidden type="radio" name='option' id="open-option" />
            <input hidden type="radio" name='option' id="close-option" />
            <div className='editIssue-options'>
                <div style={{ '--rotate': 0, '--color': '#4BADE8' }} className='option-item'>
                    <div className='item'>
                        <span title='Link issue' className='icon'>
