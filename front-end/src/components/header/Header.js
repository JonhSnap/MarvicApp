  ...
  return (
    ...
    <header className='header'>
        ...
        <div className={`header-right ${isSearchFocus ? 'grow' : ''}`}>
            <div className={`search-wrapper border-2 ${isSearchFocus ? 'border-primary' : 'border-[#ccc]'}`}>
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 icon" viewBox="0 0 20 20" fill="#ccc">
