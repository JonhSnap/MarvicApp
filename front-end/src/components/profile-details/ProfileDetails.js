    ...
    <form onSubmit={onSubmit} className="mb-5">
      <div className="flex items-center justify-around">
        <div className="relative flex flex-col">
          ...
          <input
            type="text"
            className="px-4 py-2 transition-all rounded-lg outline-blue-500"
            value={text}
          ...
          {showEdit && (
            <div className="cursor-pointer">
              ...
              <div
                ...
                className="absolute z-10 right-0 flex items-center justify-center rounded-lg w-7 h-7 bg-slate-200"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="w-6 h-6"
