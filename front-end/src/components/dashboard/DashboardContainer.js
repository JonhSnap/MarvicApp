      ...
      <div className="chart-container">
        ...
        <div className="flex gap-x-2 items-center">
          ...
          <select
            ...
            className="p-2 mt-3 border-2 capitalize border-blue-400 rounded-md cursor-pointer outline-blue-600">
            {
              timeLines.map(item => (
            ...
            <div className="flex gap-x-2 ml-5">
              <div className="flex flex-col gap-y-1">
                ...
                <input
                  ...
                  name='dateStart'
                  type="date"
                  className="border-2 border-primary rounded outline-none"
                />
              </div>
              <div className="flex flex-col gap-y-1">
