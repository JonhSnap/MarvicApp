  ...
  const dateStarted = useMemo(() => {
    ...
    switch (timeLine) {
      case 'project':
        ...
        return `${dateStartedProject.getFullYear()}-${String(dateStartedProject.getMonth() + 1).padStart(2, '0')}-${String(dateStartedProject.getDate()).padStart(2, '0')}`;
      case 'week':
        today = new Date();
  ...
  const dateEnd = useMemo(() => {
    ...
    switch (timeLine) {
      case 'project':
        ...
        return `${dateEndProject.getFullYear()}-${String(dateEndProject.getMonth() + 1).padStart(2, '0')}-${String(dateEndProject.getDate()).padStart(2, '0')}`;
      case 'week':
        today = new Date();
