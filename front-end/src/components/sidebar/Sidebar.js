  ...
  return (
    <div className='sidebar'>
      ...
      <p className='text-sm font-semibold pl-[10px] flex gap-x-2 items-center cursor-default select-none group'>
        {
          show ?
          <svg onClick={() => setShow(prev => !prev)} xmlns="http://www.w3.org/2000/svg" className="h-3 w-3 cursor-pointer opacity-0 group-hover:opacity-100" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
