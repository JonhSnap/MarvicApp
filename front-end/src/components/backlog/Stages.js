...
function Stages({ stage, issue, project }) {
    ...
    return (
        <>
            ...
            <div ref={nodeRef} onClick={handleClick} className='whitespace-nowrap rounded-md h-4 w-auto uppercase text-xs font-bold  mx-2 border-solid border-[0.5px] border-[#ccc] flex justify-center items-center py-3 px-2 bg-[#ccc]'>
                {stage?.stage_Name}
