    ...
    <>
      <div className="w-[1320px] mx-auto">
        ...
        <div className={`${classes.root}  border-2 p-2 rounded-lg mt-2 pb-5`}>
          ...
          <TabPanel value={value} index={0} className="w-[900px] h-[600px] ">
            <>
              <TutorialIntroduce />
            </>
          </TabPanel>
          <TabPanel value={value} index={1} className="w-[900px] h-[600px]">
            <TutorialStudy />
          </TabPanel>
          <TabPanel value={value} index={2} className="w-[900px] h-[600px]">
            <TutorialFunction />
          </TabPanel>
        </div>
      </div>
