              ...
              <div id="main-tutorial">
                ...
                >
                  ...
                  <div className="content">
                    <p>
                      Dựa trên phương pháp luận chuyển đổi số FPT Digital
                      Kaizen, Chúng tôi cung cấp các dịch vụ tư vấn tùy chỉnh
                      dựa trên chiến lược và định hướng phát triển, các đặc điểm
                      và thế mạnh sẵn có của khách hàng, để phát triển và tăng
                      trưởng, dưới dạng một lộ trình triển khai toàn diện và chi
                      tiết. Tập trung vào hai lĩnh vực chính là Tư vấn chuyển
                      đổi số cho doanh nghiệp và Tư vấn cho các tỉnh, thành phố.
                    </p>
                    <p>
                      Trong lĩnh vực Tư vấn chuyển đổi số doanh nghiệp, Chúng
                      tôi thiết kế lộ trình chuyển đổi số tùy chỉnh cho doanh
                      nghiệp dựa trên những điều kiện nền tảng là hệ thống công
                      nghệ thông tin và đội ngũ nhân lực số giúp doanh nghiệp
                      Vận hành xuất sắc, Trải nghiệm khách hàng vượt trội, Mô
                      hình kinh doanh đổi mới, Kích hoạt năng lực công nghệ, Xây
                      dựng đội ngũ nhân lực số.
                    </p>
                    <p>
                      Trong lĩnh vực Tư vấn cho các tỉnh thành, cùng các đối tác
                      tư vấn chiến lược hàng đầu và các đối tác triển khai công
                      nghệ, FPT cung cấp dịch vụ Tư vấn quy hoạch phát triển
                      kinh tế xã hội và dịch vụ Tư vấn chuyển đổi số hướng tới
                      sự phát triển nhảy vọt và bền vững.
                    </p>
                  </div>
                </motion.div>
                <motion.div
                  ...
                  {booleanText && (
                    <>
                      ...
                      <div className="content">
                        <p>
                          Dựa trên phương pháp luận chuyển đổi số FPT Digital
                          Kaizen, Chúng tôi cung cấp các dịch vụ tư vấn tùy
                          chỉnh dựa trên chiến lược và định hướng phát triển,
                          các đặc điểm và thế mạnh sẵn có của khách hàng, để
                          phát triển và tăng trưởng, dưới dạng một lộ trình
                          triển khai toàn diện và chi tiết. Tập trung vào hai
                          lĩnh vực chính là Tư vấn chuyển đổi số cho doanh
                          nghiệp và Tư vấn cho các tỉnh, thành phố.
                        </p>
                        <p>
                          Trong lĩnh vực Tư vấn chuyển đổi số doanh nghiệp,
                          Chúng tôi thiết kế lộ trình chuyển đổi số tùy chỉnh
                          cho doanh nghiệp dựa trên những điều kiện nền tảng là
                          hệ thống công nghệ thông tin và đội ngũ nhân lực số
                          giúp doanh nghiệp Vận hành xuất sắc, Trải nghiệm khách
                          hàng vượt trội, Mô hình kinh doanh đổi mới, Kích hoạt
                          năng lực công nghệ, Xây dựng đội ngũ nhân lực số.
                        </p>
                        <p>
