            ...
            <div className="basis-[70%] ml-10 mx-auto mt-[40px] float-right">
              <div className="flex flex-col justify-center">
                <h2 className="text-base text-[#172b4d] ">
                  Quản lý thông tin cá nhân của bạn, đồng thời kiểm soát thông
                  tin nào người khác xem được và ứng dụng nào có thể truy cập.
                </h2>
                ...
                <div className="w-full h-[230px]  rounded-lg header-avt  border-slate-500 border-2">
                  ...
                  <form onSubmit={handleSubmitAvt}>
                    <div className="mt-10 ml-5">
                      ...
                      <button
                        type="submit"
                        className="inline-block p-2 mt-2 text-white transition-all cursor-pointer hover:bg-slate-400 hover: bg-slate-500 label-avt rounded-2xl"
                      >
                        <label
                          htmlFor="input-avt"
              ...
              <div className="mt-10">
                ...
                {user && user?.fullName && user?.userName && user?.email ? (
                  <div className="p-5 pb-10 border-2 rounded-lg border-slate-600">
                    ...
                    <ProfileDetails
                      handleSubmit={(text) =>
                        updateUserUserEmail(text, user.id)
                      }
                      label={"Email address"}
