  ...
  return (
    <div className="w-[1320px] mx-auto flex flex-col mt-8">
      <div className="flex flex-col">
        ...
        <div className="workon-header p-5 text-white rounded-2xl flex items-center ">
          <div className="border-b-2 border-white inline-block cursor-pointer mr-5 p-4 rounded-lg hover:bg-blue-600">
            <h3 className="text-xl font-semibold">Worked on</h3>
          </div>
          <div className="inline-block cursor-pointer mr-5">
