        ...
        <div className={classes.root}>
          ...
          >
            <div className="flex flex-col animate__animated animate__fadeInLeft">
              <h2 className="text-2xl font-bold uppercase heading-test animate__animated animate__zoomInDown animate__delay-2s">
                Các khái niệm được dùng trong ứng dụng
              </h2>
              <div className="ml-5">
                <h3 className="text-base font-semibold ">
                  1. Vòng đời Quản lý dự án (Project Management Life Cycle) là
                  gì?
                </h3>
                <span className="ml-5">
              ...
              <div className="mt-5 ml-5">
                <h3 className="text-base font-semibold ">
                  2. Các giai đoạn trong 1 dự án (Project Management Life Cycle
                  Phases):
                </h3>
