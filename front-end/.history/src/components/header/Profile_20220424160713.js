    ...
    <>
      {user ? (
        <div className="relative">
          ...
          {show && (
            <div
              className={`absolute user-profile bg-white shadow-lg  w-[310px] right-0 p-4 rounded-lg flex text-slate-600 border  items-center flex-col animate__animated animate__fadeInTopRight`}
            >
