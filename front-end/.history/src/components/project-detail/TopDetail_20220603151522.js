            ...
            >
              ...
              {showMembers && (
                <div className="current-members">
                  ...
                  {showAllMembers && (
                    <div className="absolute top-[100%] border-2 overflow-auto have-y-scroll border-slate-500 h-auto max-h-[125px] left-[100%] z-50 p-4 rounded-lg shadow-lg bg-slate-50">
                      {members.length > 0 ? (
                        members.map((item) => (
                          <div
                            key={v4()}
