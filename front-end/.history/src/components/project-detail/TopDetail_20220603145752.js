            ...
            >
              ...
              {showMembers && (
                <div className="current-members">
                  ...
                  {showAllMembers && (
                    <div className="absolute top-0 left-[200%] z-50 p-4 rounded-lg shadow-lg bg-slate-50">
                      {members.length > 0 ? (
                        members.map((item) => (
                          <div
                            key={v4()}
                            className="w-full flex justify-between items-center px-[10px] mb-3"
                          >
                            <input type="checkbox" />
