...
function TopDetail({ project }) {
  ...
  console.log("members", members.jobTitle === "Product Onwer");
  return (
    <div className="top">
      {showEpic && (
        <FilterEpicSelectBox
            ...
            >
              ...
              {showMembers && (
                <div className="current-members">
                  ...
                  {showAllMembers && (
                    <div className="absolute top-[100%] border-2 border-slate-500 h-auto max-h-[225px] left-[100%] z-50 p-4 rounded-lg shadow-lg bg-slate-50">
                      {members.length > 0 ? (
                        members.map((item) => (
                          <div
                            key={v4()}
                          ...
                          >
                            <input
                              type="checkbox"
                              checked={members.jobTitle === "Product Onwer"}
                            />
