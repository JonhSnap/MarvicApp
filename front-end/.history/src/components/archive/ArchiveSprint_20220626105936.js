    ...
    <>
      <div className="flex flex-col mt-4 rounded-lg">
        {showIssue && (
          <div
            id="style-16"
            className="flex animate__animated animate__animated animate__fadeInDown flex-col pt-2 h-auto overflow-y-auto border-2 border-blue-400 rounded-lg p-2   pl-2 pb-2 max-h-[280px]"
          >
