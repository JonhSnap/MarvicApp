  ...
  return (
    <div className="flex flex-col mt-4 rounded-lg">
      ...
      {showIssue && (
        <div
          id="style-16"
          className="flex animate__animated animate__animated animate__bounce flex-col pt-2 h-auto overflow-y-auto border-l-2 border-slate-300 shadow-lg pl-2 pb-2 max-h-[280px]"
        >
