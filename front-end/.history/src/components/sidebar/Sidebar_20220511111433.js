...
function Sidebar({ nameProject = 'Name of project'}) {
  ...
  return (
    <div className='sidebar'>
      <div className="name">
        <img src="https://media.istockphoto.com/photos/abstract-cloud-computing-technology-concept-picture-id1316144933?b=1&k=20&m=1316144933&s=170667a&w=0&h=jQa0mn3U1ePZMYdTY7zisheCQqUItm2_itt_Jq5UZmU=" alt="" />
        <p>{nameProject}</p>
      </div>
      <p className='text-sm font-semibold pl-[10px] flex gap-x-2 items-center cursor-default select-none group'>
        {
          show ?
          <svg onClick={() => setShow(prev => !prev)} xmlns="http://www.w3.org/2000/svg" className="w-3 h-3 opacity-0 cursor-pointer group-hover:opacity-100" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      ...
      <div className="wrap-link">
        ...
        <NavLink to={`/projects/backlog/${keyCurrentProject}`}>
          <span>
            ...
            <path d="M5 5v2h12V5H5zm-2-.002C3 3.894 3.895 3 4.994 3h12.012C18.107 3 19 3.898 19 4.998V9H3V4.998z"></path></g>
            </svg>
          </span>
          <span>Backlog</span>
        </NavLink>
        <NavLink to={`/projects/board/${keyCurrentProject}`}>
          ...
          <svg width="24" height="24" viewBox="0 0 24 24" role="presentation">
            ...
            <path d="M8 6v12h2V6zm6 0v12h2V6z"></path></g>
            </svg>
          </span>
          <span>Board</span>
        </NavLink>
