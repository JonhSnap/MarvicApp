...
const BarChart = () => {
    ...
    data: [
      {
        ...
        dataPoints: [
          { x: Date.parse("2017- 01- 01"), y: 84.927 },
          { x: Date.parse("2017- 02- 01"), y: 82.609 },
          { x: Date.parse("2017- 03- 01"), y: 81.428 },
          { x: Date.parse("2017- 04- 01"), y: 83.259 },
          { x: Date.parse("2017- 05- 01"), y: 83.153 },
          { x: Date.parse("2017- 06- 01"), y: 84.18 },
          { x: Date.parse("2017- 07- 01"), y: 84.84 },
          { x: Date.parse("2017- 08- 01"), y: 82.671 },
          { x: Date.parse("2017- 09- 01"), y: 87.496 },
          { x: Date.parse("2017- 10- 01"), y: 86.007 },
          { x: Date.parse("2017- 11- 01"), y: 87.233 },
          { x: Date.parse("2017- 12- 01"), y: 86.276 },
        ],
      },
      // {
      //   type: "area",
  ...
  console.log("Date.parse)", Date.parse("2017- 01- 01").format("DD/MM/YYYY"));
  return (
    <div className="p-5">
      {/* <div className="mt-">
