    ...
    data: [
      {
        ...
        dataPoints: [
          ...
          { new Date("2017- 02- 01"), y: 82.609 },
          { new Date("2017- 03- 01"), y: 81.428 },
          { new Date("2017- 04- 01"), y: 83.259 },
          { new Date("2017- 05- 01"), y: 83.153 },
          { new Date("2017- 06- 01"), y: 84.18 },
          { new Date("2017- 07- 01"), y: 84.84 },
          { new Date("2017- 08- 01"), y: 82.671 },
          { new Date("2017- 09- 01"), y: 87.496 },
          { new Date("2017- 10- 01"), y: 86.007 },
          { new Date("2017- 11- 01"), y: 87.233 },
          { new Date("2017- 12- 01"), y: 86.276 },
        ],
      },
      // {
      //   type: "area",
