    ...
    data: [
      {
        ...
        dataPoints: [
          { x: new Date(2017, 2), y: 7.6 },
          { x: new Date(2016, 3), y: 7.3 },
          { x: new Date(2015, 4), y: 6.4 },
          { x: new Date(2014, 5), y: 5.3 },
          { x: new Date(2013, 6), y: 4.5 },
          { x: new Date(2012, 7), y: 3.8 },
          { x: new Date(2011, 9), y: 3.2 },
        ],
      },
    ],
  };
