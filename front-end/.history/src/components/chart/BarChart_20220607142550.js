    ...
    data: [
      {
        ...
        dataPoints: [
          { x: new Date(2017, 10), y: 7.6 },
          { x: new Date(2016, 10), y: 7.3 },
          { x: new Date(2015, 10), y: 6.4 },
          { x: new Date(2014, 10), y: 5.3 },
          { x: new Date(2013, 10), y: 4.5 },
          { x: new Date(2012, 10), y: 3.8 },
          { x: new Date(2011, 10), y: 3.2 },
        ],
      },
    ],
  };
