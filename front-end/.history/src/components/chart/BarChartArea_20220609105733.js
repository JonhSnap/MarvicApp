...
const BarChartArea = ({project}) => {
  ...
  const dataP = async () => {
    await axios
      .get(
        `${BASE_URL}/api/Issue/StatisticIssueArchived?idProject=${project?.a42b223b-faec-48e3-8e28-51fe1b22fa7c}&dateStarted=${project?.dateStarted}&dateEnd=${project?.dateEnd}`
      )
      .then((res) => {
