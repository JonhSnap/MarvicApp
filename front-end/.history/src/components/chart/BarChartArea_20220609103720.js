...
const BarChartArea = () => {
  ...
  const dataP = async () => {
    await axios
      .get(
        "https://localhost:5001/api/Issue/StatisticIssueArchived?idProject=a42b223b-faec-48e3-8e28-51fe1b22fa7c&dateStarted=2022-04-21T00%3A00%3A00&dateEnd=2022-09-21T00%3A00%3A00"
      )
      .then((res) => {
