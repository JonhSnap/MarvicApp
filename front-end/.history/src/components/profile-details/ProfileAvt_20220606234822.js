      ...
      <div className="w-full h-[270px]  rounded-lg header-avt  border-slate-500 border-2">
        ...
        <div className="mt-10 ml-5">
          <input
            ...
            id="input-avt"
            accept="image/*"
            value={widow.location.href}
            className="cursor-pointer "
            onChange={showPriview}
          />
          <div className="inline-block p-2 mt-2 text-white transition-all bg-blue-300 cursor-pointer hover:opacity-90 hover: label-avt rounded-2xl">
            <label
              htmlFor="input-avt"
        ...
        <div className="flex justify-between p-4">
          <button
            type="submit"
            className="px-3 py-2 mr-4 text-base text-white bg-blue-500 rounded-lg hover:bg-blue-600"
          >
            Đăng ảnh đại diện
          </button>
        </div>
