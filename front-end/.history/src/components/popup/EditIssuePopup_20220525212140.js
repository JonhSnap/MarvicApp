  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="font-bold m-1">Description</div>
        <div>
          <input
        ...
        <div className="child-isue">
          <div className="flex justify-between w-full h-11 items-center my-2">
            <div className="font-bold m-1">Child issue</div>
        ...
        <div className="link-issue mb-6">
          <div className="flex justify-between w-full h-11 items-center my-2">
            <div className="font-bold m-1">Link issue</div>
            <div className="flex h-full w-fit items-center">
              <FontAwesomeIcon
                size="2x"
                className="mx-4 text-[1.5rem]"
        ...
        <div className="flex flex-col">
          ...
          <div className="flex justify-between">
            ...
            <div className="w-fit h-5  p-2 inline-flex justify-center items-center mx-2">
              Newest first
              <FontAwesomeIcon
                size="1x"
                className="px-2 inline-block"
