          ...
          <div className="flex w-[235px]">
            <>
              ...
              <div className=" w-[40px] [h-40px] relative">
                <div className="absolute inset-0 flex items-center justify-center text-white bg-black rounded-full opacity-50 item-center">
                  <span className="absolute z-10 text-whit">
