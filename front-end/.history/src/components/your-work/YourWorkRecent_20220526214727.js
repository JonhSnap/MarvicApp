    ...
    <div className="w-[240px] h-[170px] border-l-[20px] rounded-lg border-2  border-blue-400 mt-4 cursor-pointer p-4">
      <div className="flex flex-col">
        ...
        <div className=" mt-4">
          ...
          <div className="flex justify-between ml-2 hover:bg-slate-100 rounded-lg px-1 items-center">
            <span className="text-xs font-normal">My open issues</span>
            <p className="w-[15px] h-[15px] text-center flex items-center rounded-xs bg-slate-200 text-slate-600">
