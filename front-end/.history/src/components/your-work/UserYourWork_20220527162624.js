...
const UserYourWork = ({ user }) => {
  ...
  return (
    <>
      <div className="w-[40px] [h-40px] absolute z-0 ">
        {isHovered ? (
        ...
        {/* <span className="absolute top-0 right-0 z-10 w-10 h-10 px-2 py-1 text-sm text-white bg-black rounded-lg userhover t-100 l-0">
          {user.userName}
        </span> */}
        <img
          ref={hoverRef}
