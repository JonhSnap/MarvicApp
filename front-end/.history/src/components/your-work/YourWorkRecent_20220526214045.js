  ...
  return (
    <div className="w-[240px] h-[170px] border-l-[20px] rounded-lg border-2  border-blue-400 mt-4 cursor-pointer p-4">
      <div className="flex flex-col">
        ...
        <div className="ml-[12px] mt-4">
          <span className="text-[12px] cursor-text  text-slate-500 font-semibold">
            QUICK LINKS
          </span>
          <div className="flex justify-between mt-4 hover:bg-slate-200 rounded-lg p-1 items-center">
