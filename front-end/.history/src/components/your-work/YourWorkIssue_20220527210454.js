...
const YourWorkIssue = ({ dataIssue }) => {
  ...
  const [userMembet, sestUserMembet] = useState(false);
  return (
          ...
          <div className="flex w-[235px]">
            <>
              ...
              <div className=" w-[40px] h-[40px] relative ">
                <div className="absolute inset-0 z-10 flex items-center justify-center text-white bg-black rounded-full opacity-50 item-center">
                ...
                />
                <div className="absolute flex flex-col top-[100%] p-5 z-[9999] bg-slate-50 rounded-lg">
