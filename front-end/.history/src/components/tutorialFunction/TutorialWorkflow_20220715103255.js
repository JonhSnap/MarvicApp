          ...
          <ul className="ml-2">
            ...
            <li className="mt-4">
              ...
              <ul className="ml-2">
                <li>
                  <h3>
                    <strong className="text-blue-800">A Worked on:</strong>{" "}
                ...
                <li className="mt-2">
                  <h3>
                    <strong className="text-blue-800"> B Assignee:</strong>Liệt
                ...
                <li className="mt-2">
                  <h3>
                    <strong className="text-blue-800">C Starred: </strong> Liết
