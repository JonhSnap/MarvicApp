  ...
  return (
    <div className="overflow-y-auto have-y-scroll h-[400px] animate__animated animate__lightSpeedInLeft pb-3">
      ...
      <div className="mt-4">
        ...
        <div className="mt-4">
          <p>
            <span className="text-base text-blue-900">Step 2:</span> Chọn thuộc
        ...
        <div className="mt-4">
          <p>
            <span className="text-base text-blue-900">Step 3:</span> Sau khi
      ...
      <div className="mt-4">
        ...
        <div className="mt-4">
          <p>
            <span className="text-base text-blue-900">Step 3:</span> Kết quả tạo
            Label
          </p>
      ...
      <div className="mt-4">
        ...
        <div className="mt-4">
          <p>
            <span className="text-base text-blue-900">Step 2:</span> Một cửa sổ
            sẽ hiện ra
          </p>
        ...
        <div className="mt-4">
          <p>
            <span className="text-base text-blue-900">Step 3:</span> : Nhập tên
        ...
        <div className="mt-4">
          <p>
            <span className="text-base text-blue-900">Step 4:</span> : Click vào
      ...
      <div className="mt-4">
        ...
        <div>
          <p>
            <span className="text-base text-blue-900">Step 1:</span> Tại tab
        ...
        <div className="mt-4">
          <p>
            <span className="text-base text-blue-900">Step 2:</span> Thay đổi
        ...
        <div className="mt-4">
          <p>
            <span className="text-base text-blue-900">Step 3:</span> Chọn “Edit
            sprint”
          </p>
      ...
      <div className="mt-4">
        ...
        <div>
          <p>
            <span className="text-base text-blue-900">Step 1:</span> Chọn Issue
        ...
        <div className="mt-4">
          <p>
            <span className="text-base text-blue-900">Step 2:</span> Tại nhóm
      ...
      <div className="mt-4">
        ...
        <div className="mt-4">
          <p>
            <span className="text-base text-blue-900">Step 2:</span> Nhập các
        ...
        <div className="mt-4">
          <p>
            <span className="text-base text-blue-900">Step 3:</span> Click nút
      ...
      <div className="mt-4">
        ...
        <div>
          <p>
            <span className="text-base text-blue-900">Step 1:</span> Đến Board
            của Project.
          </p>
        ...
        <div className="mt-4">
          <p>
            <span className="text-base text-blue-900">Step 2:</span> Thực hiện
      ...
      <div className="mt-4">
        ...
        <div>
          <p>
            <span className="text-base text-blue-900">Step 1:</span> Chuyển đến
        ...
        <div className="mt-4">
          <p>
            <span className="text-base text-blue-900">Step 2:</span> Xác định
