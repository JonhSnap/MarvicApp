      ...
      <div className="mt-4">
        ...
        <div>
          <div className="flex">
            ...
            <div className="ml-10 text-base text-blue-800">
              <h2>Người dùng thực hiện tạo Project bằng cách</h2>
              <ul>
                <li>o Đặt tên</li>
                <li>o Xác định thời gian bắt đầu và kết thúc</li>
                <li>o Quyền truy cập của Project (Public, Private, Limited)</li>
                <li>o Từ khóa của Project (tên viết tắt).</li>
              </ul>
            </div>
          </div>
        </div>
