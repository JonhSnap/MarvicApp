...
const TutorialIntroduce = () => {
  return (
    <div className="flex flex-col animate__animated animate__fadeInLeft ml-[-24px] mt-[10px]">
      <h2 className="text-2xl font-bold text-blue-800 uppercase heading-test animate__animated animate__rollIn animate__delay-1s">
        Các khái niệm được dùng trong ứng dụng
      </h2>
      <div className="ml-5">
        <h3 className="text-base font-semibold ">
          1. Vòng đời Quản lý dự án (Project Management Life Cycle) là gì?
        </h3>
        <span className="ml-5">
      ...
      <div className="mt-5 ml-5">
        <h3 className="text-base font-semibold ">
          2. Các giai đoạn trong 1 dự án (Project Management Life Cycle Phases):
        </h3>
        <h4 className="ml-5 font-semibold">
          Process (Quy trình) của vòng đời Quản lý Dự án được chia thành 5 phần
          chính:
        </h4>
        <div className="ml-10">
          ...
          <p className="mt-2 ">
            Tất cả các thông tin liên quan đến dự án được note vào Điều lệ dự án
            và các biên bản của các bên liên quan. Khi điều lệ dự án được phê
            duyệt, dự án chính thức được bắt đầu bởi Project Owner.
          </p>
        </div>
        <div className="mt-3 ml-10">
          <p className="text-blue-600">
            B. Giai đoạn lập kế hoạch (Project Planning Stage):Giai đoạn Lập kế
            hoạch dự án bao gồm khoảng 50% của toàn bộ quá trình.
          </p>
          <ul>
            ...
            <li>• Thu hút sự tham gia của toàn bộ member ở buổi brainstorm</li>
            <li>
            ...
            <li>
              ...
              <ul className="ml-5 ">
                <li>
                  ...
                  <p className="ml-5">
                    Luôn cập nhật đầy đủ thông tin đến các Member thông qua các
                    cuộc họp trực tuyến được quy định thời gian từ trước dựa vào
                    Sprint hiện tại đang được thực hiện. Đảm bảo việc giao tiệp
                    kịp thời và rõ ràng, ít điểm mù hơn, làm việc theo nhóm tốt
                    hơn và có kế hoạch đối ứng tốt nhất.
                  </p>
                </li>
                <li className="mt-3">
                  ii. Minh bạch:
                  <p className="ml-5">
                    Tránh tình trạng làm việc khi chưa nắm rõ bối cảnh chung của
                    dự án, để khi gặp các trở ngại có thể dễ dàng giải quyết.
                    Xác định rõ người chịu trách nhiệm cho nhiệm vụ bằng các mô
                    tả chi tiết cho Issue.
                  </p>
                </li>
                <li className="mt-3">
                ...
                <li className="mt-3">
                  ...
                  <p className="ml-5">
                    ...
                    trong 1 khoảng thời gian nhất định (thường là theo tuần hay
                    tháng).
                  </p>
                </li>
              </ul>
        ...
        <div className="mt-3 ml-10">
          ...
          <ul>
            <li>
              • Nếu không thể đo lường được khối lượng công việc của dự án, thì
              không thể quản lý theo cách tốt nhất. Giai đoạn này yêu cầu kiểm
              tra để đảm bảo mọi thứ đều phù hợp với những gì đã thống nhất
              trước đó. Các chỉ số liên quản chính là gì? Cần thực hiện những gì
              để đáp ứng thời hạn và các thông số liên quản đó?
            </li>
            <li>
        ...
        <div className="mt-3 ml-10">
          ...
          <ul>
            <li>
              • Kết thúc dự án cũng quan trọng như bắt đầu. Còn được gọi là giai
              đoạn “theo dõi”, đây là khoảng thời gian khi dự án hoàn thành đã
              sẵn sàng để ra mắt công chúng. Trọng tâm chính ở đây là phát hành
              và phân phối sản phẩm.
            </li>
            <li>
              • Điều quan trọng đối với người quản lý dự án là đánh giá vòng đời
              của dự án từ đầu đến cuối bằng cách:
              <ul className="ml-5 ">
                <li>
                  i. Điều tra hiệu suất dự án
                  <p className="ml-5">
                    Mọi thành viên có đạt được mục tiêu đã đề ra của họ không?
                    Dự án có được hoàn thành trong ngân sách và thời gian không?
                    Dự án có giải quyết được vấn đề gì không? Giải quyết những
                    câu hỏi này sẽ giúp việc đánh giá xem dự án có thành công
                    hay không.
                  </p>
                </li>
                <li className="mt-3">
                  ...
                  <p className="ml-5">
                    ...
                    Kiểm tra chất lượng, KPI và cuộc họp trực tuyến có tác dụng
                    cung cấp thông tin chi tiết rõ ràng hơn về hiệu suất.
                  </p>
                </li>
                <li className="mt-3">
                  ...
                  <p className="ml-5">
                    ...
                    hiện sự phát triển của dự án từ khi hình thành đến khi giao
                    hàng đảm bảo hoàn thành đúng cách cho khách hàng và các bên
                    liên quan.
                  </p>
                </li>
                <li className="mt-3">
                ...
                <li className="mt-3">
                  ...
                  <p className="ml-5">
                    ...
                    cũng như các nguồn lực chưa được sử dụng giúp hiểu rõ hơn về
                    thành công (hoặc thất bại) và giúp quản lý lãng phí.
                  </p>
                </li>
              </ul>
            </li>
