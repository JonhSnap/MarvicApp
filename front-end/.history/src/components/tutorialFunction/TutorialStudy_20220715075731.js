          ...
          <div>
            ...
            <ul className="mt-1 ml-5">
              <li>
                ...
                Trello có giao diện làm việc cực kỳ thân thiện, các thao tác
                không quá phức tạp. Bạn chỉ cần tạo danh sách, thêm thẻ việc cần
                làm hay việc thêm thành viên cũng đơn giản chỉ cần thêm email
                hoặc gửi link truy cập. Ngoài ra trên Trello còn cung cấp nhiều
                mẫu bảng với các chủ đề khác nhau khá đa dạng và đẹp mắt.
              </li>
              <li>
                <h3 className="text-base text-blue-800">B. Miễn phí</h3>Trello
                hiện đang cung cấp sản phẩm dưới hình thức Freemium, tức là
