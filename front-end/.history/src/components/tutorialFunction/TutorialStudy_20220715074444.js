      ...
      <TabPanel value={value} index="one">
        <div>
          ...
          <ul>
            ...
            <li>•	Chức năng thông báo giúp người dùng không bỏ xót thông tin.</li>
            ...
            <li>•	Có 1 hệ sinh thái hỗ trợ nhiều sản phẩm, giúp người dùng hoạt động 1 cách đồng bộ với các ứng dụng khác.</li>
          </ul>
        </div>
      </TabPanel>
