    ...
    <div className="container">
      ...
      <div className="flex">
        <div className="border-2 border-slate-200  outline-none out basis-[20%]">
          <div className="epic-dropdown have-y-scroll p-2 w-[300px] h-[500px] overflow-y-auto mx-4 bg-white rounded-[5px] flex items-center flex-col">
            ...
            {issueEpics.length > 0 &&
              issueEpics.map((item) => (
                <div
                  key={v4()}
                  onClick={() => handleChooseEpic(item.id)}
                  className={`w-full p-3 relative z-[-1] flex flex-col font-semibold shadow-md rounded-[5px] mb-2 cursor-pointer  `}
                >
                  <div className="flex items-center">
                    <FontAwesomeIcon
                      size="1x"
