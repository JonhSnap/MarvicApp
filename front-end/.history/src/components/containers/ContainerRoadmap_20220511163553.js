...
const ContainerRoadmap = ({ project }) => {
  ...
  return (
    <div className="container">
          ...
          <div className="filters">
            ...
            >
              ...
              <div
                ...
                className="epic-dropdown z-[9999] have-y-scroll p-2 w-[300px] h-[200px] overflow-y-auto mx-4 bg-white rounded-[5px] flex items-center flex-col"
              >
      ...
      <div className="flex">
        <div className="border-2  h-[470px] border-slate-200  outline-none out basis-[20%]">
          <div className="epic-dropdown have-y-scroll p-2 w-[300px]  overflow-y-auto mx-4 bg-white rounded-[5px] flex items-center flex-col">
            ...
            {issueEpics.length > 0 &&
              issueEpics.map((item) => (
                <>
                  <div
                    key={v4()}
                    className={`w-full p-3 relative flex flex-col font-semibold  shadow-md rounded-[5px] mb-2 cursor-pointer hover:bg-slate-200 h-[300px] overflow-y-auto `}
                  >
                    <div className="flex items-center">
                      <FontAwesomeIcon
                        size="1x"
                    ...
                    <div
                      className="icon-plus absolute w-[25px] h-[25px] top-1/3 right-2 items-center flex justify-center rounded-lg bg-slate-200 hover:bg-slate-300"
